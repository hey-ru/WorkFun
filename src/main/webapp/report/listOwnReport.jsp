...
<body>
	<input type="hidden" id="loginId" value="<%=session.getAttribute("empVO")==null?"":((EmpVO)session.getAttribute("empVO")).getEmpId() %>">
	<%
		EmpVO empVO = (EmpVO)session.getAttribute("empVO");
		Integer reporter = empVO.getEmpId();
		ReportService repSvc = new ReportService();
		List<ReportVO> list = repSvc.getOwn(reporter);
