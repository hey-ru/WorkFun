...
<jsp:useBean id="listByCompositeQuery" scope="request" type="java.util.List<ReportVO>" />
  ...
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/reportServlet" name="form1">
       ...
       <select size="1" name="status" >
							...
							<div class="col-sm-12">
									...
									<table class="table table-bordered dataTable" id="dataTable"
										...
										<%@ include file="/design/page1_ByCompositeQuery.file"%>
											<c:forEach var="reportVO" items="${listByCompositeQuery}"
		...
		<% String yourServlet = "/reportServlet"; %>
