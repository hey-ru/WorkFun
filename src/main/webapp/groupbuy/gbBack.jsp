...
<%@ include file="/design/backSidebar.jsp"%>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<div class="row">
							<div class="col-11" style="height: 60px; display: inline-block;">
								<form class="my-1 col-10 row" METHOD="post" ACTION="<%=request.getContextPath()%>/groupbuy/GroupBuyServlet" name="formserch">
...
<!-- 									</div> -->
									<div class="form-group col-4" style="display: inline-block">
										<input type="text" class="form-control"
											id="serchInput" placeholder="輸入查詢內容"
											style="border: gray solid 2px;" name="buyer">
									</div>
									<input type="hidden" name="action" value="listByCompositeQueryBack">
<!-- 									<input type="hidden" id="serchGbId" name="gb_id"> -->
<!-- 									<input type="hidden" id="serchShopName" name="shop_name"> -->
<!-- 									<input type="hidden" id="serchOwner" name="gb_owner"> -->
...
<!-- <script> -->
// $(#serchInput).change( function() {  
// 	$(#serchGbId).val = $(#serchInput).val;
// 	$(#serchShopName).val = $(#serchInput).val;
// 	$(#serchOwner).val = $(#serchInput).val;
// });
