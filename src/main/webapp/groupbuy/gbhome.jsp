					...
					<c:forEach var="groupBuyVO" items="${list}"
						...
						<div class="col-lg-4 col-md-6 portfolio-item filter-card">
							<div class="portfolio-wrap">
								<div style="color:white; padding:5px; z-index:99;background:rgba(0,255,204,0.4);height:100px;width:300px;">
								<h5>${groupBuyVO.gb_id} <strong>${groupBuyVO.shop_name}</strong></h5>
								...
								<div class="portfolio-info">									
									<div class="portfolio-links">
										<FORM METHOD="post"
											ACTION="<%=request.getContextPath()%>/groupbuylist/GroupBuyListServlet"
											style="margin-bottom: 0px;">
											<input type="submit" value="加入"> <input type="hidden"
												name="gb_id" value="${groupBuyVO.gb_id}">
											<input type="hidden" name="action" value="joinGB">
										</FORM>
<!-- 										<a -->
<%-- 											href="${pageContext.request.contextPath}/groupbuylist/addGroupBuyList.jsp" --%>
<!-- 											class="portfolio-details-lightbox" -->
<!-- 											data-glightbox="type: external" title="加入揪團"> <i -->
<!-- 											class="bx bx-link"></i> -->
<!-- 										</a> -->
									</div>
								</div>
