<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <!-- ======= Header ======= -->
        <header id="header">
            <div class="container-fluid d-flex justify-content-between align-items-center headerdiv">
                        ...
                        <li>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    <a href="../webapp/groupbuy/gb_home_1.html"> 主頁 </a>
                                    <a href="../webapp/groupbuy/shoplist.html">我要揪團</a>
                                    <a href="#">查詢揪團</a>
                                    <a href="#">查詢參團</a>
                                </div>
                            </div>
                        ...
                        <ul>
                            ...
                            <li class="nav-item dropdown pe-3">
                                ...
                                <a class="nav-link nav-profile d-flex align-items-center pe-0 ; width:2px" href="#"
                                    ...
                                    <img src="${pageContext.request.contextPath}/assets/img/wu.jpeg" alt="Profile"
