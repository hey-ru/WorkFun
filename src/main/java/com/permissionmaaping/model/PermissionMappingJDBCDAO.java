...
//	}
	...
	public Set<PermissionMappingVO> findByPrimaryKey(Integer empId) {
		Set<PermissionMappingVO> set = new HashSet<PermissionMappingVO>();
		...
		try {
			...
			while (rs.next()) {
				...
				permissionMappingVO = new PermissionMappingVO();
								...
								set.add(permissionMappingVO); // Store the row in the list
							}
