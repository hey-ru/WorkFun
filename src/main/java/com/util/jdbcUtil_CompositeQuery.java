...
//		if ("is_deal".equals(columnName) || "sal".equals(columnName) || "comm".equals(columnName) || "deptno".equals(columnName)) // 原本樣子
		if ("is_deal".equals(columnName) || "shop_type".equals(columnName) || "gb_status".equals(columnName) || "is_disable".equals(columnName)|| "gb_id".equals(columnName) || "gb_owner".equals(columnName)  || "eq_status".equals(columnName) || "buyer".equals(columnName) || "booking_id".equals(columnName) || "return_status".equals(columnName)) // 用於其他
